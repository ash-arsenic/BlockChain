...
const CandidatePair = new PersistentMap<string, string[]>("Candiate Pair");
...
// const VPromptArray = new PersistentVector<string>("Prompt Vector");
//view methods
...
export function getUrl(name: string): string {
  if (CandidateURL.contains(name)) {
    ...
    logging.log("cannnot find that user");
    return "";
  }
}
